...
if __name__ == "__main__":
    ...
    dataset_reader = DatasetReaderKITTI("./video/05/")
    ...
    for frame_no in range(1, 2500):
        ...
        track_positions.append(
            np.array([camera_pos[0][0], 0.0, camera_pos[2][0]]) * 0.05
        )
        kitti_positions.append(
            np.array([kitti_pos[0], kitti_pos[1], kitti_pos[2]]) * 0.05
        )
